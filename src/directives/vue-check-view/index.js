    ...
    function createInstance(Vue) {
        ...
        function scrollHandler() {
            let viewportTop = window.pageYOffset,
                ...
                viewportWidth = window.document.documentElement.scrollWidth,
            ...
            function getInType(i) {
                const rect = i.element.getBoundingClientRect(),
                    elementTop = rect.top + viewportTop - viewportWidth * .066,
                    elementBottom = rect.top + viewportTop + rect.height + viewportWidth * .066,
